...
const MAP_CONTEXTS = {
    ...
    9: {
        ...
        summary: 'אליהו גזר בצורת על הארץ ונאלץ להסתתר מפני אחאב ואיזבל. ה׳ שלח אותו לנחל כרית שבעבר הירדן, שם ניזון בנס מהעורבים. לאחר שהתייבש הנחל, נשלח צפונה לצרפת שליד צידון, שם בצע נס כד הקמח.',
        verses: [
    ...
    10: {
        ...
        summary: 'הר הכרמל — שלוחה ירוקה מרהיבה מצפון-מערב לרכס השומרון — היה הזירה לעימות הגדול בין אליהו לנביאי הבעל. אליהו, לבדו מול 450 נביאים, הוכיח שה׳ הוא האלוהים האמיתי כאשר האש ירדה ואכלה את הקורבן.',
        verses: [
    ...
    11: {
        ...
        summary: 'מאפיין ייחודי של אליהו הנביא: הוא עבר במקומות רבים בארץ ולא היה לו מקום קבוע. מוצאו מן הגלעד שבעבר הירדן המזרחי, עבר לנחל כרית, לצרפת בצפון, לכרמל, ליזרעאל, לבאר שבע ולבסוף לחורב — ובסיום פעילותו בעבר הירדן.',
        verses: []
    },
    12: {
        color: '#e74c3c',
